...
class compareView: UIViewController {
    ...
    @IBAction func menuOpened(sender: AnyObject) {
        performSegueWithIdentifier("compareMenuSegue", sender: nil)
    }
    ...
    override func viewDidLoad() {
        ...
        menuButton.addTarget(self, action: #selector(compareView.menuOpened(_:)), forControlEvents:.TouchUpInside)
