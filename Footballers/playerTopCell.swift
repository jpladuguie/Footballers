...
class playerTopCell: UITableViewCell {
    ...
    override init(style: UITableViewCellStyle, reuseIdentifier: String?) {
        ...
        self.flagImage.frame = CGRect(x: (UIScreen.main.bounds.width / 6) - 17.25, y: 14.75, width: 34.5, height: 25.5)
        self.contentView.addSubview(flagImage)
        
        // Country label.
        self.countryLabel = UITextView()
        self.countryLabel.frame = CGRect(x: 0, y: 45, width: UIScreen.main.bounds.width / 3, height: 50)
        ...
        self.ageLabel.frame = CGRect(x: UIScreen.main.bounds.width / 3, y: 0, width: UIScreen.main.bounds.width / 3, height: 45)
        ...
        self.ageDescLabel.frame = CGRect(x: UIScreen.main.bounds.width / 3, y: 45, width: UIScreen.main.bounds.width / 3, height: 30)
        ...
        self.teamImage.frame = CGRect(x: ((UIScreen.main.bounds.width * 5) / 6) - 17.5, y: 10, width: 35, height: 35)
        self.contentView.addSubview(self.teamImage)
        
        // Team label.
        self.teamLabel = UITextView()
        self.teamLabel.frame = CGRect(x: (UIScreen.main.bounds.width * 2) / 3, y: 45, width: UIScreen.main.bounds.width / 3, height: 50)
