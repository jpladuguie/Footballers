...
class rankingsView: UIViewController {
    ...
    @IBAction func menuOpened(sender: AnyObject) {
        performSegueWithIdentifier("rankingsMenuSegue", sender: nil)
    }
    ...
    override func viewDidLoad() {
        ...
        menuButton.addTarget(self, action: #selector(rankingsView.menuOpened(_:)), forControlEvents:.TouchUpInside)
