...
class NVActivityIndicatorAnimationBallRotate: NVActivityIndicatorAnimationDelegate {
    ...
    func setUpAnimation(in layer: CALayer, size: CGSize, color: UIColor) {
        ...
        // Draw circles
        let leftCircle = NVActivityIndicatorShape.circle.layerWith(CGSize(width: circleSize, height: circleSize), color: color)
        let rightCircle = NVActivityIndicatorShape.circle.layerWith(CGSize(width: circleSize, height: circleSize), color: color)
        let centerCircle = NVActivityIndicatorShape.circle.layerWith(CGSize(width: circleSize, height: circleSize), color: color)
