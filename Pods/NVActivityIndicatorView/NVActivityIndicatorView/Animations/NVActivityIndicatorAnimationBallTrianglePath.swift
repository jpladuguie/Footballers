...
class NVActivityIndicatorAnimationBallTrianglePath: NVActivityIndicatorAnimationDelegate {
    ...
    func setUpAnimation(in layer: CALayer, size: CGSize, color: UIColor) {
        ...
        // Top-center circle
        let topCenterCircle = NVActivityIndicatorShape.ring.layerWith(CGSize(width: circleSize, height: circleSize), color: color)
        ...
        // Bottom-left circle
        let bottomLeftCircle = NVActivityIndicatorShape.ring.layerWith(CGSize(width: circleSize, height: circleSize), color: color)
        ...
        // Bottom-right circle
        let bottomRightCircle = NVActivityIndicatorShape.ring.layerWith(CGSize(width: circleSize, height: circleSize), color: color)
