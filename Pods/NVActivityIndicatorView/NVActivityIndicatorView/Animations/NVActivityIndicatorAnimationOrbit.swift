...
class NVActivityIndicatorAnimationOrbit: NVActivityIndicatorAnimationDelegate {
    ...
    func ring1InLayer(_ layer: CALayer, size: CGSize, color: UIColor) {
        ...
        // Draw circle
        let circle = NVActivityIndicatorShape.circle.layerWith(CGSize(width: coreSize, height: coreSize), color: color)
    ...
    func satelliteInLayer(_ layer: CALayer, size: CGSize, color: UIColor) {
        ...
        // Draw circle
        let circle = NVActivityIndicatorShape.circle.layerWith(CGSize(width: satelliteSize, height: satelliteSize), color: color)
